...
-- public.agent_link_error_events definition

-- Drop table

-- DROP TABLE public.agent_link_error_events;

CREATE TABLE public.agent_link_error_events (
	error_id bigserial NOT NULL,
	tenant_id varchar NULL,
	agent_id varchar NULL,
	source_side varchar NOT NULL,
	stage varchar NOT NULL,
	category varchar DEFAULT 'runtime'::character varying NOT NULL,
